...
export default function Discover({ searchQuery , restaurants, loading, error  }) {
    ...
    <Box sx={{display: 'flex', flexDirection: 'row', bgcolor: '#f0f2f5',  } }>
            ...
            <Box sx={{p:2  } }>
                <Box sx={{ mb: 2, display: 'flex', alignItems: 'flex-start', gap: 1.5 ,flexDirection: 'column', textAlign: 'center'}}>
                   
                        <Typography variant="h5" sx={{ fontWeight: 800, color: '#123f06', letterSpacing: '-0.5px' }}>
                          Top Halal Restaurant
                        </Typography>
                    
                </Box>
                  <Box sx={{ mb: 6, display: 'flex', alignItems: 'flex-start', gap: 1 ,flexDirection: 'column', textAlign: 'flex-start'}}>
